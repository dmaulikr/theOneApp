 			...
 			.then(function(result) {
 				...
 				user.then(function(profile) {
 					if (profile.name == undefined) {
 						...
 						var genderPromise = $http.get('http://graph.facebook.com/me?fields=gender&access_token=' + accessToken);
 						var birthdayPromise = $http.get('http://graph.facebook.com/me?fields=birthday&access_token=' + accessToken);
 						var locationPromise = $http.get('http://graph.facebook.com/me?fields=location&access_token=' + accessToken);
 						var bioPromise = $http.get('http://graph.facebook.com/me?fields=about&access_token=' + accessToken);
 						var imagesPromise = $http.get('http://graph.facebook.com/me/photos/uploaded?fields=source&access_token=' + accessToken);
